  ...
  positions: [
    {
      ...
      desc: 'After its semi-hibernation last year, we&rsquo;re looking for someone to relaunch Design Days in a big way. We&rsquo;ll give the right candidate the platform and complete freedom to make this a spectacular initiative. The ideal candidate loves shows like <a href="http://99percentinvisible.org/">99% Invisible</a>, has a strong opinion on Massimo Vignelli, loves to draw, or is otherwise committed to design. As with any lead position, you must be organized, creative, and a team-player. Before applying, consider checking out <a href="http://www.meetup.com/Product-Design-Workshop">what we&rsquo;ve done in the past</a> to see what Design Days can involve.',
      priority: true,
      filled: 0,
      needed: 1
    }, {
      name: "Community Lead",
      desc: 'The community team puts on 12-15 fun events each semester that make our teams and our larger community feel closer. The ideal candidate is organized, friendly, and excited to get to know our awesome board members on a more personal level.',
      ...
      name: "Treasurer",
      desc: 'The treasurer oversees the Tech@NYU budget, tracking our income and expenses and helping to plan our spending. Candidates should be highly organized and attentive to detail.',
      ...
      desc: 'Our Business Development team works hard to secure the funds that Tec@NYU needs to properly execute its programs. It does this primarily through <a href="http://techatnyu.org/#about">sponsorships with companies</a> that believe in Tech@NYU&rsquo;s vision. The ideal candidate is interested in meeting with companies throughout NYC, is hard-working and ambitious, and a people-person.',
